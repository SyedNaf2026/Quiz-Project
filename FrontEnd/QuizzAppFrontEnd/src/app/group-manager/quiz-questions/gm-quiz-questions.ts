...
@Component({
  selector: 'app-gm-quiz-questions',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, Navbar, ConfirmDialogComponent],
  templateUrl: './gm-quiz-questions.html'
})
export class GmQuizQuestions implements OnInit {
  quizId = 0;
  quizTitle = '';
  ...
  excelColumns = [
    { num: 1, name: 'QuestionText' },
    { num: 2, name: 'QuestionType' },
    { num: 3, name: 'Option1Text' },
    { num: 4, name: 'Option1Correct' },
    { num: 5, name: 'Option2Text' },
    { num: 6, name: 'Option2Correct' },
    { num: 7, name: 'Option3Text' },
    { num: 8, name: 'Option3Correct' },
    { num: 9, name: 'Option4Text' },
    { num: 10, name: 'Option4Correct' },
  ];
  ...
  onFileSelected(event: Event): void {
    ...
    this.questionService.uploadExcel(this.quizId, file).subscribe({
      next: res => {
        ...
        if (res.success) {
          this.toast.success(res.data || 'Questions imported!');
          this.loadQuestions();
        } else {
  ...
  downloadTemplate(): void {
    // Build a CSV-style template as a downloadable hint
    const headers = [
      'QuestionText', 'QuestionType',
      'Option1Text', 'Option1Correct',
      'Option2Text', 'Option2Correct',
      'Option3Text', 'Option3Correct',
      'Option4Text', 'Option4Correct'
    ].join('\t');

    const example = [
      'What is 2+2?', 'MultipleChoice',
      '3', 'false',
      '4', 'true',
      '5', 'false',
      '6', 'false'
    ...
    a.href = url;
    a.download = 'question-bank-template.xls';
    a.click();
